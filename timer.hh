...
public:
  ...
  double GetLastDurationSec() { return lastspan; }

  double GetLastDurationUs() { return GetLastDurationSec() * 1000000.0; }
  ...
  double GetMedianDurationUs() { return GetMedianDurationSec() * 1000000.0; }

  void ReportMedian() {
    std::cout << "Test median duration                           Elapsed   ";
    std::cout << static_cast<long long>(round(GetMedianDurationUs()))
              << " us\n";
  }
